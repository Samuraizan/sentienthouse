...
const AGENT_META = {
  zomadprime: { name: "ZomadPrime", role: "director", color: "#FFD700", human: "Samurai" },
  "blrxzo-jr": { name: "BLRxZo JR", role: "captain-blrxzo", color: "#00BFFF", human: "Darshan" },
  "wtfxzo-jr": { name: "WTFxZo JR", role: "captain-wtfxzo", color: "#FF6347", human: "Akhilesh" },
  suki: { name: "Suki", role: "events", color: "#FF69B4", human: "Boldrin" },
  loki: { name: "LOKI", role: "vibe-curator", color: "#9B59B6", human: "Pooja" },
  wanda: { name: "Wanda", role: "sales", color: "#2ECC71", human: "Boldrin" },
  yana: { name: "Yana", role: "bd", color: "#E67E22", human: "Boldrin" },
};
